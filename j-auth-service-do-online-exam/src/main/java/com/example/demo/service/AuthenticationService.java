...
public class AuthenticationService {
    ...
    @Autowired
    private AbstractRepositoryImpl<User> abstractRepository;
    ...
    public ResponseEntity<?> checkUserAction(String token, int flag) {
        Long userID = Long.parseLong(String.valueOf(JwtTokenUtil.getUserInfoFromToken(token, Claims::getAudience)));
