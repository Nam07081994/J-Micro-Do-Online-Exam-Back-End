...
public class ExamService {
    ...
    public ResponseEntity<?> checkExam(String token, SubmitExamCommand command)
        ...
        double mark = 0d;
        double totalMark = 0d;
        int aNumberCorrect = 0;
        int aNumberInCorrect = 0;
        ...
        newResult.setANumberAnswerCorrect(aNumberCorrect);
        newResult.setANumberAnswerInCorrect(aNumberInCorrect);
//        newResult.setEndTimeExam(command.getEndTimeExam());
//        newResult.setStartTimeExam(command.getStartTimeExam());
