package com.example.article.jarticleservicedoonlineexam.constants;

public class Constants {

	//
	public static final String ARTICLE_DOMAIN_NAME = "articles";

	public static final String EMPTY_STRING = "";

	public static final String DOT_CHARACTER_STRING = ".";
	...
	public static final String USERNAME_TOKEN_KEY = "aud";
